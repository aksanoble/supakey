-- Deploy supakey:fix_notify_email_param to pg

BEGIN;

SET search_path TO supakey, public;

-- Fix the notify_edge_early_access function to send email as URL parameter
-- since pg_net is not reliably sending the JSON body
